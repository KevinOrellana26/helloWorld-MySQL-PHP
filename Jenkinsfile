pipeline {
    ...
    parameters {
        ...
        string(name: 'NODE_NAMESPACE', defaultValue: params.NODE_NAMESPACE ?: 'aplicaciones-comunes', description: 'Namespace for MySQL-PHP')
        ...
        stage('Build Image'){
            ...
            steps {
                sh(returnStdout: false, returnStatus:true, script: """#!/bin/bash
                    docker build -t mysql -f images/Dockerfile.mysql .
                    docker build -t php -f images/Dockerfile.php .  
                """.stripIndent())
            }
        }
